...
@register_binary_sensor("ATT", ATTBinarySensor, ATT_SCHEMA)
...
@register_trigger("ATT", ATTTrigger, ATTData)
def ATT_trigger(var, config):
    pass


@register_dumper("ATT", ATTDumper)
def ATT_dumper(var, config):
    pass
